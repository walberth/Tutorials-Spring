...
public class TestRoomServiceImpl {
	...
	public void testFindByValidRoomNumber() {
		...
		//When
		//
		Room returnedRoom = service.findByRoomNumber("1023");
	...
	public void testRoomsByFloor() {
		...
		//Then
		//
		assertThat(returnedRooms).extracting("roomType", "roomNumber")
		.containsExactly(tuple("Double", "1023"),tuple("Single", "1024"),tuple("Suite","1025"));
	}
