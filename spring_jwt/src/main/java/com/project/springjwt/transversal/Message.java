...
public class Message {
    ...
    public static final String IndicarUsuarioContrasena = "Must be indicate user and password";
    public static final String UsuarioNoEncontrado = "User Not Found";
    public static final String UsuarioDeshabilitado = "User Disabled";
